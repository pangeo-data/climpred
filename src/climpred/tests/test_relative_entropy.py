...
@requires_eofs
def test_compute_relative_entropy(PM_ds_initialized_3d, PM_ds_control_3d):
    """
    Checks that there are no NaNs.
    """
    actual = compute_relative_entropy(
        PM_ds_initialized_3d.tos, PM_ds_control_3d.tos, nmember_control=5, neofs=2
    )
...
@requires_eofs
def test_bootstrap_relative_entropy(PM_ds_initialized_3d, PM_ds_control_3d):
    """
    Checks that there are no NaNs.
    """
    actual = bootstrap_relative_entropy(
        PM_ds_initialized_3d.tos,
        PM_ds_control_3d.tos,
        nmember_control=5,
        neofs=2,
        bootstrap=2,
    )
...
@requires_eofs
@pytest.mark.skip
def test_plot_relative_entropy(PM_ds_initialized_3d, PM_ds_control_3d):
    res = compute_relative_entropy(
        PM_ds_initialized_3d, PM_ds_control_3d, nmember_control=5, neofs=2
    )
