...
def test_add_control(perfectModelEnsemble_initialized_control_1d):
    """Test to see if control can be added to PerfectModelEnsemble"""
    assert perfectModelEnsemble_initialized_control_1d.get_control()


def test_generate_uninit(perfectModelEnsemble_initialized_control_1d):
    """Test to see if uninitialized ensemble can be bootstrapped"""
    pm = perfectModelEnsemble_initialized_control_1d
    pm = pm.generate_uninitialized()
    assert pm.get_uninitialized()


def test_compute_metric(perfectModelEnsemble_initialized_control_1d):
    """Test that metric can be computed for perfect model ensemble"""
    perfectModelEnsemble_initialized_control_1d.compute_metric()


@pytest.mark.skip(reason='skip now until uninit is refactored')
def test_compute_uninitialized(perfectModelEnsemble_initialized_control_1d):
...
def test_compute_persistence(perfectModelEnsemble_initialized_control_1d):
    """Test that compute persistence can be run for perfect model ensemble"""
    perfectModelEnsemble_initialized_control_1d.compute_persistence()


@pytest.mark.slow
def test_bootstrap(perfectModelEnsemble_initialized_control_1d):
    """Test that perfect model ensemble object can be bootstrapped"""
    perfectModelEnsemble_initialized_control_1d.bootstrap(iterations=2)
...
def test_get_uninitialized(perfectModelEnsemble_initialized_control_1d):
...
def test_get_control(perfectModelEnsemble_initialized_control_1d):
    """Test whether get_control function works."""
    ctrl = perfectModelEnsemble_initialized_control_1d.get_control()
    assert ctrl == perfectModelEnsemble_initialized_control_1d._datasets['control']
...
def test_verify(perfectModelEnsemble_initialized_control_1d):
    """Test that verify works."""
    assert perfectModelEnsemble_initialized_control_1d.verify(
        metric='mse', comparison='m2e'
    )


def test_warning_compute_metric(perfectModelEnsemble_initialized_control_1d):
    """Test that compute_metric throws warning."""
    with pytest.warns(UserWarning) as record:
        assert perfectModelEnsemble_initialized_control_1d.compute_metric(
            metric='mse', comparison='m2e'
        )
        if not record:
...
def test_verify_metric_kwargs(perfectModelEnsemble_initialized_control_1d):
...
def test_verify_reference(perfectModelEnsemble_initialized_control_1d, reference):
    """Test that verify works with references given."""
    pm = perfectModelEnsemble_initialized_control_1d.generate_uninitialized()
...
def test_verify_fails_expected_metric_kwargs(perfectModelEnsemble_initialized_control_1d):
...
def test_compute_uninitialized_metric_kwargs(perfectModelEnsemble_initialized_control_1d):
...
def test_bootstrap_metric_kwargs(perfectModelEnsemble_initialized_control_1d):
