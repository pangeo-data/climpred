...
def test_eff_p_same_as_p_with_full_n(hindcast, obs):
    """Tests that the effective p value returns the same value as normal p value if the
    full sample size N is used."""
