...
from climpred.utils import check_xarray
...
@check_xarray([0, 2])
def _arbitrary_two_xr_func_random_loc(ds_da1, some_arg,
                                      ds_da2, **kwargs):
    return ds_da1, some_arg, ds_da2, kwargs


@check_xarray([0, 'da', 'other_da'])
def _arbitrary_three_xr_func_args_keys(ds, da=None,
                                       other_da=None, **kwargs):
    return ds, da, other_da, kwargs


def test_check_xarray_ds(ds1):
...
def test_check_xarray_ds_da(ds1, da1):
...
def test_check_xarray_ds_da_random_loc(ds1, da1):
...
def test_check_xarray_ds_da_args_keys(ds1, da1, da2):
