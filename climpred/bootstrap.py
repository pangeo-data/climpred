...
def resample_skill_resample_before(self, iterations, resample_dim, verify_kwargs):
    ...
    if "uninitialized" in verify_kwargs["reference"]:
        if not self.get_uninitialized():
            ...
            # faster generate once and then resample, see https://github.com/pangeo-data/climpred/blob/bec54bc03d432e64372253db5d61fa761c46d03c/climpred/bootstrap.py#L715 # noqa
